...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Scene currentScene = SceneManager.GetActiveScene();
        string sceneName = currentScene.name;
        if (sceneName == "Shotter_scene" && !LevelManaging.instance._isPaused)
        {
            RaycastHit laserHit;
    ...
    private void Move(Vector2 direction)
    {
        ...
        // Sets the speed of the character accordingly
        desiredSpeed = _maxForwardSpeed * going * Mathf.Sign(forwardDirection);

        // Goes from current forwardspeed to desiredSpeed at acceleration speed
